        ...
        <div class="user_safe">
            <div class="user_safe_item">
                ...
                <div class="user_safe_btn">
                    <div @click="iscompany?$router.push('/company/user/safe/password'):$router.push('/user/safe/password')">修改</div>
                </div>
                <div class="clear"></div>
            </div>
            ...
            <div class="user_safe_item">
                ...
                <div class="user_safe_btn">
                    <section>
                        <div @click="iscompany?$router.push('/company/user/safe/pay_password'):$router.push('/user/safe/pay_password')" class="editmargin">修改</div>
                        <div @click="iscompany?$router.push('/company/user/safe/pay_passwordforget'):$router.push('/user/safe/pay_passwordforget')">忘记密码</div>
                    </section>
                </div>
                <div class="clear"></div>
            </div>
            ...
            <div class="user_safe_item">
                ...
                <div class="user_safe_btn">
                    <div @click="iscompany?$router.push('/company/user/safe/card'):$router.push('/user/safe/card')">{{is_check==''?'立即认证':'修改认证'}}</div>
                </div>
                <div class="clear"></div>
            </div>
        </div>
...
.user_safe {
  .user_safe_item {
    ...
    .user_safe_icon {
      ...
      i {
        font-size: 24px;
        color: $main_color; //42b983  ca151e
      }
      i.success {
        color: #42b983;
      }
